/obj/docking_port/mobile
	...
	// NOVA EDIT ADDITION START - OVERMAP - back-reference to the overmap ship icon
...
/obj/docking_port/mobile/Initialize(mapload, list/areas)
	...
	// NOVA EDIT ADDITION START - OVERMAP - bind a ship icon for ports created after SSovermap init.
...
/obj/docking_port/mobile/proc/linkup(obj/docking_port/stationary/dock)
	...
	// NOVA EDIT ADDITION START - OVERMAP - re-prep the bound ship now that
