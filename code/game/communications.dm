...
GLOBAL_LIST_INIT(default_radio_channels, list(
	...
	RADIO_CHANNEL_OVERMAP = FREQ_OVERMAP, //NOVA EDIT ADDITION - OVERMAP
...
GLOBAL_LIST_INIT(reserved_radio_frequencies, list(
	...
	"[FREQ_OVERMAP]" = RADIO_CHANNEL_OVERMAP, //NOVA EDIT ADDITION - OVERMAP
...
GLOBAL_LIST_INIT(reserved_radio_colors, list(
	...
	RADIO_CHANNEL_OVERMAP = RADIO_COLOR_OVERMAP, //NOVA EDIT ADDITION - OVERMAP
))
