...
/turf/open/proc/build_shuttle_frame_with_rods(obj/item/stack/rods/shuttle/used_rods, mob/user)
	...
	new_plating.AddElementTrait(TRAIT_SHUTTLE_CONSTRUCTION_TURF, REF(used_rods), /datum/element/shuttle_construction_turf)
	to_chat(user, span_notice("You anchor shuttle frame rods into the [new_plating.name]."))
	return TRUE
