...
/obj/item/stock_parts/power_store/battery/lead
	...
	emp_damage_modifier = 32 // its literally multiple car batteries wired together. each cell is "hit by the emp" (which adds up to atotal of 32 emp damage mod)
	charge_light_type = null
...
/obj/item/stock_parts/power_store/battery/high/slime_hypercharged
	name = "hypercharged expanded slime core"
	desc = "An overfilled, hyper-charged and reinforced slime core. stuffed with plasma"
	icon = 'icons/mob/simple/slimes.dmi'
	icon_state = "yellow-core"
	rating = 7
	custom_materials = null
	maxcharge = 25 * STANDARD_BATTERY_CHARGE // 25MJ, less of an increase than the other cells got because of how strong emp-proofing is
	chargerate = 0.33 * STANDARD_BATTERY_RATE // 66.6r% decrease to charge rate, instead of base 50%, same reason as above.
	emp_damage_modifier = 0 // same gimmick here, biological cell so emp-proof.
	charge_light_type = null
